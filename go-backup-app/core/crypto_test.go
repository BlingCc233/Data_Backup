...
// TestPBKDF2Vectors 使用 RFC 6070 的测试向量
func TestPBKDF2Vectors(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			iter:        4096,
			keyLen:      25,
			expectedKey: "3d2eec4fe41c849b80c8a8461502d0537a8b2324e836778c85b5",
		},
		{
			...
			iter:        4096,
			keyLen:      32,
			expectedKey: "95c378a3587635546e960350993a2016422718e03295b9c24b94a86f1d971510",
		},
	}
